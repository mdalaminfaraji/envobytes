...
export default function OurTeamMembers() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1770&q=80",
    },
    {
      id: 3,
          ...
          <div className="overflow-hidden">
            ...
            >
              {teamMembers.map((member, index) => (
                <div key={member.id} className="min-w-[25%] px-2">
                  <div className="relative overflow-hidden group">
                    ...
                    {/* Member Info */}
                    <div className="bg-[#001d80] text-white p-4">
